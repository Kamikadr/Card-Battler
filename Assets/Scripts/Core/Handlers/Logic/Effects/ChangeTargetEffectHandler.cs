...
{
    public sealed class ChangeTargetEffectHandler: BaseHandler<ChangeTargetEffect>
    {
        private readonly IPlayerListenable _playerContainer;
        private readonly TargetProvider _targetProvider;

        public ChangeTargetEffectHandler(EventBus.EventBus eventBus, IPlayerListenable playerContainer, TargetProvider targetProvider) : base(eventBus)
        {
